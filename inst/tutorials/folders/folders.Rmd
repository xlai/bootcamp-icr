...
If also instantiates a git repository, facilitating version control.
For the time being, if you want to generate an analysis directory for a trial that does not already have one, please speak to Kristian.
